...
intrinsic_macro(get_xshard_packed) \
...
intrinsic_macro(shared_db_idx64_store) \
intrinsic_macro(shared_db_idx64_remove) \
intrinsic_macro(shared_db_idx64_update) \
intrinsic_macro(shared_db_idx64_find_primary) \
intrinsic_macro(shared_db_idx64_find_secondary) \
intrinsic_macro(shared_db_idx64_lowerbound) \
intrinsic_macro(shared_db_idx64_upperbound) \
intrinsic_macro(shared_db_idx64_end) \
intrinsic_macro(shared_db_idx64_next) \
intrinsic_macro(shared_db_idx64_previous) \
intrinsic_macro(shared_db_idx128_store) \
intrinsic_macro(shared_db_idx128_remove) \
intrinsic_macro(shared_db_idx128_update) \
intrinsic_macro(shared_db_idx128_find_primary) \
intrinsic_macro(shared_db_idx128_find_secondary) \
intrinsic_macro(shared_db_idx128_lowerbound) \
intrinsic_macro(shared_db_idx128_upperbound) \
intrinsic_macro(shared_db_idx128_end) \
intrinsic_macro(shared_db_idx128_next) \
intrinsic_macro(shared_db_idx128_previous) \
intrinsic_macro(shared_db_idx256_store) \
intrinsic_macro(shared_db_idx256_remove) \
intrinsic_macro(shared_db_idx256_update) \
intrinsic_macro(shared_db_idx256_find_primary) \
intrinsic_macro(shared_db_idx256_find_secondary) \
intrinsic_macro(shared_db_idx256_lowerbound) \
intrinsic_macro(shared_db_idx256_upperbound) \
intrinsic_macro(shared_db_idx256_end) \
intrinsic_macro(shared_db_idx256_next) \
intrinsic_macro(shared_db_idx256_previous) \
intrinsic_macro(shared_db_idx_double_store) \
intrinsic_macro(shared_db_idx_double_remove) \
intrinsic_macro(shared_db_idx_double_update) \
intrinsic_macro(shared_db_idx_double_find_primary) \
intrinsic_macro(shared_db_idx_double_find_secondary) \
intrinsic_macro(shared_db_idx_double_lowerbound) \
intrinsic_macro(shared_db_idx_double_upperbound) \
intrinsic_macro(shared_db_idx_double_end) \
intrinsic_macro(shared_db_idx_double_next) \
intrinsic_macro(shared_db_idx_double_previous) \
intrinsic_macro(shared_db_idx_long_double_store) \
intrinsic_macro(shared_db_idx_long_double_remove) \
intrinsic_macro(shared_db_idx_long_double_update) \
intrinsic_macro(shared_db_idx_long_double_find_primary) \
intrinsic_macro(shared_db_idx_long_double_find_secondary) \
intrinsic_macro(shared_db_idx_long_double_lowerbound) \
intrinsic_macro(shared_db_idx_long_double_upperbound) \
intrinsic_macro(shared_db_idx_long_double_end) \
intrinsic_macro(shared_db_idx_long_double_next) \
intrinsic_macro(shared_db_idx_long_double_previous) \
intrinsic_macro(shared_db_store_i64) \
intrinsic_macro(shared_db_update_i64) \
intrinsic_macro(shared_db_remove_i64) \
intrinsic_macro(shared_db_get_i64) \
intrinsic_macro(shared_db_next_i64) \
intrinsic_macro(shared_db_previous_i64) \
intrinsic_macro(shared_db_find_i64) \
intrinsic_macro(shared_db_lowerbound_i64) \
intrinsic_macro(shared_db_upperbound_i64) \
intrinsic_macro(shared_db_end_i64) \
...
intrinsic_macro(get_shard_name) \
