...
namespace eosio {
  namespace internal_use_do_not_use {
    extern "C" {
      ...
      int32_t shared_db_store_i64(uint64_t, uint64_t, uint64_t, uint64_t,  const void*, uint32_t);

      __attribute__((eosio_wasm_import))
      void shared_db_update_i64(int32_t, uint64_t, const void*, uint32_t);

      __attribute__((eosio_wasm_import))
      void shared_db_remove_i64(int32_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_get_i64(int32_t, const void*, uint32_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_next_i64(int32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_previous_i64(int32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_find_i64(uint64_t, uint64_t, uint64_t, uint64_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_lowerbound_i64(uint64_t, uint64_t, uint64_t, uint64_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_upperbound_i64(uint64_t, uint64_t, uint64_t, uint64_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_end_i64(uint64_t, uint64_t, uint64_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx64_store(uint64_t, uint64_t, uint64_t, uint64_t, const uint64_t*);

      __attribute__((eosio_wasm_import))
      void shared_db_idx64_update(int32_t, uint64_t, const uint64_t*);

      __attribute__((eosio_wasm_import))
      void shared_db_idx64_remove(int32_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx64_next(int32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx64_previous(int32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx64_find_primary(uint64_t, uint64_t, uint64_t, uint64_t*, uint64_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx64_find_secondary(uint64_t, uint64_t, uint64_t, const uint64_t*, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx64_lowerbound(uint64_t, uint64_t, uint64_t, uint64_t*, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx64_upperbound(uint64_t, uint64_t, uint64_t, uint64_t*, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx64_end(uint64_t, uint64_t, uint64_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx128_store(uint64_t, uint64_t, uint64_t, uint64_t, const uint128_t*);

      __attribute__((eosio_wasm_import))
      void shared_db_idx128_update(int32_t, uint64_t, const uint128_t*);

      __attribute__((eosio_wasm_import))
      void shared_db_idx128_remove(int32_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx128_next(int32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx128_previous(int32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx128_find_primary(uint64_t, uint64_t, uint64_t, uint128_t*, uint64_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx128_find_secondary(uint64_t, uint64_t, uint64_t, const uint128_t*, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx128_lowerbound(uint64_t, uint64_t, uint64_t, uint128_t*, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx128_upperbound(uint64_t, uint64_t, uint64_t, uint128_t*, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx128_end(uint64_t, uint64_t, uint64_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx256_store(uint64_t, uint64_t, uint64_t, uint64_t, const uint128_t*, uint32_t);

      __attribute__((eosio_wasm_import))
      void shared_db_idx256_update(int32_t, uint64_t, const uint128_t*, uint32_t);

      __attribute__((eosio_wasm_import))
      void shared_db_idx256_remove(int32_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx256_next(int32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx256_previous(int32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx256_find_primary(uint64_t, uint64_t, uint64_t, uint128_t*, uint32_t, uint64_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx256_find_secondary(uint64_t, uint64_t, uint64_t, const uint128_t*, uint32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx256_lowerbound(uint64_t, uint64_t, uint64_t, uint128_t*, uint32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx256_upperbound(uint64_t, uint64_t, uint64_t, uint128_t*, uint32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx256_end(uint64_t, uint64_t, uint64_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_double_store(uint64_t, uint64_t, uint64_t, uint64_t, const double*);

      __attribute__((eosio_wasm_import))
      void shared_db_idx_double_update(int32_t, uint64_t, const double*);

      __attribute__((eosio_wasm_import))
      void shared_db_idx_double_remove(int32_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_double_next(int32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_double_previous(int32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_double_find_primary(uint64_t, uint64_t, uint64_t, double*, uint64_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_double_find_secondary(uint64_t, uint64_t, uint64_t, const double*, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_double_lowerbound(uint64_t, uint64_t, uint64_t, double*, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_double_upperbound(uint64_t, uint64_t, uint64_t, double*, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_double_end(uint64_t, uint64_t, uint64_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_long_double_store(uint64_t, uint64_t, uint64_t, uint64_t, const long double*);

      __attribute__((eosio_wasm_import))
      void shared_db_idx_long_double_update(int32_t, uint64_t, const long double*);

      __attribute__((eosio_wasm_import))
      void shared_db_idx_long_double_remove(int32_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_long_double_next(int32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_long_double_previous(int32_t, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_long_double_find_primary(uint64_t, uint64_t, uint64_t, long double*, uint64_t);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_long_double_find_secondary(uint64_t, uint64_t, uint64_t, const long double*, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_long_double_lowerbound(uint64_t, uint64_t, uint64_t, long double*, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_long_double_upperbound(uint64_t, uint64_t, uint64_t, long double*, uint64_t*);

      __attribute__((eosio_wasm_import))
      int32_t shared_db_idx_long_double_end(uint64_t, uint64_t, uint64_t);
    }
  };

#define WRAP_SHARED_SECONDARY_SIMPLE_TYPE(IDX, TYPE)\
template<>\
struct shared_secondary_index_db_functions<TYPE> {\
   static int32_t db_idx_next( int32_t iterator, uint64_t* primary )          { return internal_use_do_not_use::shared_db_##IDX##_next( iterator, primary ); } \
   static int32_t db_idx_previous( int32_t iterator, uint64_t* primary )      { return internal_use_do_not_use::shared_db_##IDX##_previous( iterator, primary ); } \
   static void    db_idx_remove( int32_t iterator  )                          { internal_use_do_not_use::shared_db_##IDX##_remove( iterator ); } \
   static int32_t db_idx_end( uint64_t code, uint64_t scope, uint64_t table ) { return internal_use_do_not_use::shared_db_##IDX##_end( code, scope, table ); } \
   static int32_t db_idx_store( uint64_t scope, uint64_t table, uint64_t payer, uint64_t id, const TYPE& secondary ) {\
     return internal_use_do_not_use::shared_db_##IDX##_store( scope, table, payer, id, &secondary ); \
   }\
   static void    db_idx_update( int32_t iterator, uint64_t payer, const TYPE& secondary ) {\
     internal_use_do_not_use::shared_db_##IDX##_update( iterator, payer, &secondary ); \
   }\
   static int32_t db_idx_find_primary( uint64_t code, uint64_t scope, uint64_t table, uint64_t primary, TYPE& secondary ) {\
     return internal_use_do_not_use::shared_db_##IDX##_find_primary( code, scope, table, &secondary, primary ); \
   }\
   static int32_t db_idx_find_secondary( uint64_t code, uint64_t scope, uint64_t table, const TYPE& secondary, uint64_t& primary ) {\
     return internal_use_do_not_use::shared_db_##IDX##_find_secondary( code, scope, table, &secondary, &primary ); \
   }\
   static int32_t db_idx_lowerbound( uint64_t code, uint64_t scope, uint64_t table, TYPE& secondary, uint64_t& primary ) {\
     return internal_use_do_not_use::shared_db_##IDX##_lowerbound( code, scope, table, &secondary, &primary ); \
   }\
   static int32_t db_idx_upperbound( uint64_t code, uint64_t scope, uint64_t table, TYPE& secondary, uint64_t& primary ) {\
     return internal_use_do_not_use::shared_db_##IDX##_upperbound( code, scope, table, &secondary, &primary ); \
   }\
};

#define WRAP_SHARED_SECONDARY_ARRAY_TYPE(IDX, TYPE)\
template<>\
struct shared_secondary_index_db_functions<TYPE> {\
   static int32_t db_idx_next( int32_t iterator, uint64_t* primary )          { return internal_use_do_not_use::shared_db_##IDX##_next( iterator, primary ); } \
   static int32_t db_idx_previous( int32_t iterator, uint64_t* primary )      { return internal_use_do_not_use::shared_db_##IDX##_previous( iterator, primary ); } \
   ...
   static int32_t db_idx_end( uint64_t code, uint64_t scope, uint64_t table ) { return internal_use_do_not_use::shared_db_##IDX##_end( code, scope, table ); } \
   static int32_t db_idx_store( uint64_t scope, uint64_t table, uint64_t payer, uint64_t id, const TYPE& secondary ) {\
     return internal_use_do_not_use::shared_db_##IDX##_store( scope, table, payer, id, secondary.data(), TYPE::num_words() ); \
   }\
   static void    db_idx_update( int32_t iterator, uint64_t payer, const TYPE& secondary ) {\
     internal_use_do_not_use::shared_db_##IDX##_update( iterator, payer, secondary.data(), TYPE::num_words() ); \
   }\
   static int32_t db_idx_find_primary( uint64_t code, uint64_t scope, uint64_t table, uint64_t primary, TYPE& secondary ) {\
     return internal_use_do_not_use::shared_db_##IDX##_find_primary( code, scope, table, secondary.data(), TYPE::num_words(), primary ); \
   }\
   static int32_t db_idx_find_secondary( uint64_t code, uint64_t scope, uint64_t table, const TYPE& secondary, uint64_t& primary ) {\
     return internal_use_do_not_use::shared_db_##IDX##_find_secondary( code, scope, table, secondary.data(), TYPE::num_words(), &primary ); \
   }\
   static int32_t db_idx_lowerbound( uint64_t code, uint64_t scope, uint64_t table, TYPE& secondary, uint64_t& primary ) {\
     return internal_use_do_not_use::shared_db_##IDX##_lowerbound( code, scope, table, secondary.data(), TYPE::num_words(), &primary ); \
   }\
   static int32_t db_idx_upperbound( uint64_t code, uint64_t scope, uint64_t table, TYPE& secondary, uint64_t& primary ) {\
     return internal_use_do_not_use::shared_db_##IDX##_upperbound( code, scope, table, secondary.data(), TYPE::num_words(), &primary ); \
   }\
};

namespace _shared_multi_index_detail {

   template<typename T>
   struct shared_secondary_index_db_functions;

   template<typename T>
   struct secondary_key_traits;

   WRAP_SHARED_SECONDARY_SIMPLE_TYPE(idx64,  uint64_t)
   MAKE_TRAITS_FOR_ARITHMETIC_SECONDARY_KEY(uint64_t)

   WRAP_SHARED_SECONDARY_SIMPLE_TYPE(idx128, uint128_t)
   MAKE_TRAITS_FOR_ARITHMETIC_SECONDARY_KEY(uint128_t)

   WRAP_SHARED_SECONDARY_SIMPLE_TYPE(idx_double, double)
   template<>
   struct secondary_key_traits<double> {
      static constexpr double true_lowest() { return -std::numeric_limits<double>::infinity(); }
   };

   WRAP_SHARED_SECONDARY_SIMPLE_TYPE(idx_long_double, long double)
   template<>
   ...
   WRAP_SHARED_SECONDARY_ARRAY_TYPE(idx256, eosio::fixed_bytes<32>)
   template<>
...
/**
 * @ingroup shared_multiindex
 *
 * @brief Defines GAX Shared Multi Index Table
 * @details GAX Shared Multi-Index API provides a C++ interface to the GAX Shared database. It is patterned after Boost Multi Index Container.
 * GAX Shared Multi-Index table requires exactly a uint64_t primary key. For the table to be able to retrieve the primary key,
 * the object stored inside the table is required to have a const member function called primary_key() that returns uint64_t.
 * GAX Shared Multi-Index table also supports up to 16 secondary indices. The type of the secondary indices could be any of:
 * - uint64_t
 * - uint128_t
 * - double
 * - long double
 ...
 *       auto code = _self;
 *       auto scope = _self;
 *       shared_multi_index<"mytable"_n, record,
...
class shared_multi_index
{
   private:

      static_assert( std::is_same_v<decltype(_shared_multi_index_detail::to_raw_key(std::declval<T>().primary_key())), uint64_t>,
                     "Primary key must be uint64_t or name" );
      static_assert( sizeof...(Indices) <= 16, "shared_multi_index only supports a maximum of 16 secondary indices" );
      ...
      static_assert( validate_table_name( name(TableName) ), "shared_multi_index does not support table names with a length greater than 12");
      ...
      struct item : public T
      {
         ...
         item( const shared_multi_index* idx, Constructor&& c )
         :__idx(idx){
            c(*this);
         }

         const shared_multi_index* __idx;
      ...
      struct index {
         public:
            ...
            static_assert( validate_index_name( name(IndexName) ), "invalid index name used in shared_multi_index" );
            ...
            struct const_iterator : public std::iterator<std::bidirectional_iterator_tag, const T> {
               public:
                  ...
                  const_iterator& operator++() {
                     using namespace _shared_multi_index_detail;

                     eosio::check( _item != nullptr, "cannot increment end iterator" );

                     if( _item->__iters[Number] == -1 ) {
                        secondary_key_type temp_secondary_key;
                        auto idxitr = shared_secondary_index_db_functions<secondary_key_type>::db_idx_find_primary(_idx->get_code().value, _idx->get_scope(), _idx->name(), _item->primary_key(), temp_secondary_key);
                        auto& mi = const_cast<item&>( *_item );
                        mi.__iters[Number] = idxitr;
                     }

                     uint64_t next_pk = 0;
                     auto next_itr = shared_secondary_index_db_functions<secondary_key_type>::db_idx_next( _item->__iters[Number], &next_pk );
                     if( next_itr < 0 ) {
                        _item = nullptr;
                        return *this;
                     }
                  ...
                  const_iterator& operator--() {
                     ...
                     if( !_item ) {
                        auto ei = shared_secondary_index_db_functions<secondary_key_type>::db_idx_end(_idx->get_code().value, _idx->get_scope(), _idx->name());
                        eosio::check( ei != -1, "cannot decrement end iterator when the index is empty" );
                        prev_itr = shared_secondary_index_db_functions<secondary_key_type>::db_idx_previous( ei , &prev_pk );
                        ...
                        prev_itr = shared_secondary_index_db_functions<secondary_key_type>::db_idx_previous( _item->__iters[Number], &prev_pk );
               ...
               private:
                  ...
                  const index* _idx;
                  const item*  _item;
            }; /// struct shared_multi_index::index::const_iterator
            ...
            const_iterator lower_bound( const secondary_key_type& secondary )const {
               ...
               auto itr = shared_secondary_index_db_functions<secondary_key_type>::db_idx_lowerbound( get_code().value, get_scope(), name(), secondary_copy, primary );
            ...
            const_iterator upper_bound( const secondary_key_type& secondary )const {
               ...
               uint64_t primary = 0;
               secondary_key_type secondary_copy(secondary);
               auto itr = shared_secondary_index_db_functions<secondary_key_type>::db_idx_upperbound( get_code().value, get_scope(), name(), secondary_copy, primary );
               if( itr < 0 ) return cend();
            ...
            const_iterator iterator_to( const T& obj ) {
               ...
               eosio::check( objitem.__idx == _multidx, "object passed to iterator_to is not in shared_multi_index" );

               if( objitem.__iters[Number] == -1 ) {
                  secondary_key_type temp_secondary_key;
                  auto idxitr = shared_secondary_index_db_functions<secondary_key_type>::db_idx_find_primary(get_code().value, get_scope(), name(), objitem.primary_key(), temp_secondary_key);
         ...
         private:
            friend class shared_multi_index;

            index( typename std::conditional<IsConst, const shared_multi_index*, shared_multi_index*>::type midx )
            :_multidx(midx){}

            typename std::conditional<IsConst, const shared_multi_index*, shared_multi_index*>::type _multidx;
      }; /// struct shared_multi_index::index
      ...
      const item& load_object_by_primary_iterator( int32_t itr )const {
         ...
         auto size = internal_use_do_not_use::shared_db_get_i64( itr, nullptr, 0 );
         ...
         internal_use_do_not_use::shared_db_get_i64( itr, buffer, uint32_t(size) );
         ...
         auto pk   = _shared_multi_index_detail::to_raw_key(itm->primary_key());
   ...
   public:
       ...
       *
       * Notes
       * The `eosio::shared_multi_index` template has template parameters `<name::raw TableName, typename T, typename... Indices>`, where:
       ...
       *     typedef eosio::shared_multi_index< "address"_n, address > address_index;
       *     void myaction() {
       ...
       * @endcode
       */
      shared_multi_index( name code, uint64_t scope )
      ...
      struct const_iterator : public std::iterator<std::bidirectional_iterator_tag, const T> {
         ...
         const_iterator& operator++() {
            ...
            uint64_t next_pk;
            auto next_itr = internal_use_do_not_use::shared_db_next_i64( _item->__primary_itr, &next_pk );
            if( next_itr < 0 )
               _item = nullptr;
            else
         ...
         const_iterator& operator--() {
            ...
            if( !_item ) {
               auto ei = internal_use_do_not_use::shared_db_end_i64(_multidx->get_code().value, _multidx->get_scope(), static_cast<uint64_t>(TableName));
               eosio::check( ei != -1, "cannot decrement end iterator when the table is empty" );
               prev_itr = internal_use_do_not_use::shared_db_previous_i64( ei , &prev_pk );
               eosio::check( prev_itr >= 0, "cannot decrement end iterator when the table is empty" );
            } else {
               prev_itr = internal_use_do_not_use::shared_db_previous_i64( _item->__primary_itr, &prev_pk );
         ...
         private:
            const_iterator( const shared_multi_index* mi, const item* i = nullptr )
            :_multidx(mi),_item(i){}

            const shared_multi_index* _multidx;
            const item*        _item;
            friend class shared_multi_index;
      }; /// struct shared_multi_index::const_iterator
      ...
      const_iterator lower_bound( PK primary )const {
         uint64_t primary_int = _shared_multi_index_detail::to_raw_key(primary);
         auto itr = internal_use_do_not_use::shared_db_lowerbound_i64( _code.value, _scope, static_cast<uint64_t>(TableName), primary_int );
         if( itr < 0 ) return end();
      ...
      const_iterator upper_bound( PK primary )const {
         uint64_t primary_int = _shared_multi_index_detail::to_raw_key(primary);
         auto itr = internal_use_do_not_use::shared_db_upperbound_i64( _code.value, _scope, static_cast<uint64_t>(TableName), primary_int );
         if( itr < 0 ) return end();
         const auto& obj = load_object_by_primary_iterator( itr );
         return {this, &obj};
      }
      ...
      uint64_t available_primary_key()const {
         if( _next_primary_key == unset_next_primary_key ) {
            // This is the first time available_primary_key() is called for this shared_multi_index instance.
       ...
       *     typedef eosio::shared_multi_index< name("address"), address, indexed_by< name("zip"), const_mem_fun<address, uint64_t, &address::by_zip> > address_index;
       *     void myaction() {
       *       // create reference to address_index  - see emplace example below
       *       // add dan account to table           - see emplace example below
      ...
      auto get_index() {
         ...
         static_assert( index_num < sizeof...(Indices), "name provided is not the name of any secondary index within shared_multi_index" );
      ...
      const_iterator iterator_to( const T& obj )const {
         const auto& objitem = static_cast<const item&>(obj);
         eosio::check( objitem.__idx == this, "object passed to iterator_to is not in shared_multi_index" );
         return {this, &objitem};
      }
      /**
      ...
      const_iterator emplace( name payer, Lambda&& constructor ) {
         ...
         eosio::check( _code == current_receiver(), "cannot create objects in table of another contract" ); // Quick fix for mutating db using shared_multi_index that shouldn't allow mutation. Real fix can come in RC2.
         ...
         auto itm = std::make_unique<item>( this, [&]( auto& i ){
            ...
            uint64_t pk = _shared_multi_index_detail::to_raw_key(obj.primary_key());

            i.__primary_itr = internal_use_do_not_use::shared_db_store_i64( _scope, static_cast<uint64_t>(TableName), payer.value, pk, buffer, size );
            ...
            bluegrass::meta::for_each(indices_type{}, [&](auto idx){
                  ...
                  i.__iters[index_type::number()] = shared_secondary_index_db_functions<typename index_type::secondary_key_type>::db_idx_store( _scope, index_type::name(), payer.value, obj.primary_key(), index_type::extract_secondary_key(obj) );
            });
         });
      ...
      void modify( const T& obj, name payer, Lambda&& updater ) {
         ...
         const auto& objitem = static_cast<const item&>(obj);
         eosio::check( objitem.__idx == this, "object passed to modify is not in shared_multi_index" );
         auto& mutableitem = const_cast<item&>(objitem);
         eosio::check( _code == current_receiver(), "cannot modify objects in table of another contract" ); // Quick fix for mutating db using shared_multi_index that shouldn't allow mutation. Real fix can come in RC2.
         ...
         eosio::check( pk == _shared_multi_index_detail::to_raw_key(obj.primary_key()), "updater cannot change primary key when modifying an object" );
         ...
         internal_use_do_not_use::shared_db_update_i64( objitem.__primary_itr, payer.value, buffer, size );
            ...
            if( memcmp( &std::get<index_type::index_number>(secondary_keys), &secondary, sizeof(secondary) ) != 0 ) {
               ...
               if( indexitr < 0 ) {
                  ...
                  indexitr = mutableitem.__iters[index_type::number()]
                           = shared_secondary_index_db_functions<typename index_type::secondary_key_type>::db_idx_find_primary( _code.value, _scope, index_type::name(), pk,  temp_secondary_key );
               }

               shared_secondary_index_db_functions<typename index_type::secondary_key_type>::db_idx_update( indexitr, payer.value, secondary );
            }
         } );
      }
      ...
      const_iterator find( PK primary )const {
         ...
         uint64_t primary_int = _shared_multi_index_detail::to_raw_key(primary);
         auto itr = internal_use_do_not_use::shared_db_find_i64( _code.value, _scope, static_cast<uint64_t>(TableName), primary_int );
         if( itr < 0 ) return end();
      ...
      void erase( const T& obj ) {
         ...
         const auto& objitem = static_cast<const item&>(obj);
         eosio::check( objitem.__idx == this, "object passed to erase is not in shared_multi_index" );
         eosio::check( _code == current_receiver(), "cannot erase objects in table of another contract" ); // Quick fix for mutating db using shared_multi_index that shouldn't allow mutation. Real fix can come in RC2.
         ...
         eosio::check( itr2 != _items_vector.rend(), "attempt to remove object that was not in shared_multi_index" );

         internal_use_do_not_use::shared_db_remove_i64( objitem.__primary_itr );
         ...
         bluegrass::meta::for_each(indices_type{}, [&](auto idx){
            ...
            if( i < 0 ) {
              ...
              i = shared_secondary_index_db_functions<typename index_type::secondary_key_type>::db_idx_find_primary( _code.value, _scope, index_type::name(), objitem.primary_key(),  secondary );
            }
            if( i >= 0 )
               shared_secondary_index_db_functions<typename index_type::secondary_key_type>::db_idx_remove( i );
         });
